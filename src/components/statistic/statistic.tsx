...
const Statistic = () => {
  return (
    <div className='bg-purple-medium rounded-lg p-3 w-1/3 relative'>
      <div className="p-4 bg-white shadow-lg rounded-2xl">
        <div className="flex items-center">
          ...
          <p className="ml-2 text-md text-gray-dark font-semibold">Finance</p>
        </div>
        <div className="flex flex-col justify-start">
          <p className="my-4 text-4xl font-bold text-left text-gray-dark">12,500<span className="text-sm">$</span></p>
      ...
      <div
        className="p-4 mx-auto text-center bg-white border-t-4 border-indigo-500 rounded shadow w-84 mt-8">
        <div className="overflow-hidden">
          <div className="mb-8 text-2xl font-medium text-gray-800">
            Premium
          </div>
      ...
      <div className='absolute top-6 right-4'>
        <img src={coins} alt="Coins image" className="w-40 h-44"/>
      </div>
    </div>
  );
};
